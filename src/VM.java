...
public abstract class VM extends LexVM
{
	...
	public static void instructionUnit()
	{
		...
		case Goto: case NewIntArray: case NewFloatArray: case Aload: case Astore: 
		case Iaload: case Iastore: case Faload: case Fastore: case Print:
		{
		...
		case IntToFloat: case Return: case Areturn: 
	...
	public static void runtimeError(int i, int address, String inst, int j)
	{
		...
		break;
		case 5: msg = "Error: Attempt to store into array element at out-of-bounds index, "+ j + ",";
		break;
		case 6: msg = "Error: Attempt to construct array with non-positive index size, "+ j +",";
		break;
		case 7: msg = "Error: Attempt to load into array element at out-of-bounds index, "+ j + ",";
		}
